...
```{r}
mt_genes_2_ranges <- GRanges(seqnames = "NC_035159.1",ranges = IRanges(start = mt_genes_2$start/100000,end = mt_genes_2$end/100000),genes=mt_genes_2$gene, y0=0,y1=0.13)
